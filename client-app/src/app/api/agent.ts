...
axios.interceptors.response.use(async response => {
        ...
        if(pagination) {
            ...
            return response as AxiosResponse<PaginatedRusult<any>>
        }
        return response;
...
const Activities = {
    list: (params: URLSearchParams) => axios.get<PaginatedRusult<Activity[]>>('/activities', {params}).then(responseBody),
